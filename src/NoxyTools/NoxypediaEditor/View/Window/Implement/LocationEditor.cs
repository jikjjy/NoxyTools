...
{
    public class LocationEditor : LocationEditorWindow
    {
        ...
        private LocationSet mSelectItem = new LocationSet();
        private DataTable mDataTable = new DataTable();

        public LocationEditor() : base()
        {
            initializeComponent();
            registEvent();
        }
        ...
        private void initializeComponent()
        {
            ...
            mDataTable.Columns.Add(GridColumn.RAWDATA, typeof(LocationSet));
        ...
        private void grdItemGrade_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                mSelectItem = (grdList.SelectedRows[0].Cells[GridColumn.RAWDATA].Value as LocationSet).DeepClone();
            }
            updateEditUi();
        }
        ...
        {
            if (mNoxpedia.Data.ModifyLocation(mSelectItem) == false)
            {
                txbName.Focus();
                txbName.SelectAll();
        ...
        {
            if (mNoxpedia.Data.Locations.Any(item => item.Name == mSelectItem.Name) == false)
            {
            ...
            mNoxpedia.Data.DeleteLocation(mSelectItem);
            updateList();
            mNoxpedia.RasieDataChangedEvent();
        }
        ...
        {
            if (mNoxpedia.Data.AddLocation(mSelectItem) == false)
            {
                txbName.Focus();
                txbName.SelectAll();
        ...
        private void commandRenameItem()
        {
            ...
            if (mNoxpedia.Data.Locations.Any(item => item.Name == mSelectItem.Name) == true)
            {
        ...
        private void updateEditUi()
        {
            ...
            bool existItem = mNoxpedia.Data.Locations.Any(item => item.Name == mSelectItem.Name);
        ...
        private void updateList(string recoveryItemName = "")
        {
            ...
            foreach (var item in mNoxpedia.Data.Locations)
            {
