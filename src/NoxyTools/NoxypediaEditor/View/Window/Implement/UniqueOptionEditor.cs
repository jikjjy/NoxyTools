...
{
    public class UniqueOptionEditor : UniqueOptionEditorWindow
    {
        ...
        private UniqueOptionSet mSelectItem = new UniqueOptionSet();
        private DataTable mDataTable = new DataTable();

        public UniqueOptionEditor() : base()
        {
            initializeComponent();
            registEvent();
        }
        ...
        private void initializeComponent()
        {
            ...
            mDataTable.Columns.Add(GridColumn.RAWDATA, typeof(UniqueOptionSet));
        ...
        private void registEvent()
        {
            ...
            txbEffectDescription.Validating += txbEffectDescription_Validating;
        ...
        private void grdList_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                mSelectItem = (grdList.SelectedRows[0].Cells[GridColumn.RAWDATA].Value as UniqueOptionSet).DeepClone();
            }
            updateEditUi();
        }
        ...
        private void txbEffectDescription_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            mSelectItem.EffectDescription = txbEffectDescription.Text;
            updateEditUi();
        }
        ...
        {
            if (mNoxpedia.Data.ModifyUniqueOption(mSelectItem) == false)
            {
                txbName.Focus();
                txbName.SelectAll();
        ...
        {
            if (mNoxpedia.Data.UniqueOptions.Any(item => item.Name == mSelectItem.Name) == false)
            {
            ...
            mNoxpedia.Data.DeleteUniqueOption(mSelectItem);
            updateList();
            mNoxpedia.RasieDataChangedEvent();
        }
        ...
        {
            if (mNoxpedia.Data.AddUniqueOption(mSelectItem) == false)
            {
                txbName.Focus();
                txbName.SelectAll();
        ...
        private void commandRenameItem()
        {
            ...
            if (mNoxpedia.Data.UniqueOptions.Any(item => item.Name == mSelectItem.Name) == true)
            {
        ...
        {
            pnlBase.SplitterDistance = mConfig.UniqueOptionEditor.WindowSplitterDistance;
        }

        private void saveUiSetting()
        {
            mConfig.UniqueOptionEditor.WindowSplitterDistance = pnlBase.SplitterDistance;
        }
        ...
        private void updateEditUi()
        {
            ...
            txbEffectDescription.Text = mSelectItem.EffectDescription;

            bool existItem = mNoxpedia.Data.UniqueOptions.Any(item => item.Name == mSelectItem.Name);
        ...
        private void updateList(string recoveryItemName = "")
        {
            ...
            foreach (var item in mNoxpedia.Data.UniqueOptions)
            {
