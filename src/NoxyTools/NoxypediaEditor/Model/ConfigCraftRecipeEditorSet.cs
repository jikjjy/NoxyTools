...
{
    public class ConfigCraftRecipeEditorSet
    {
        ...
        private static readonly string REGISTRY_PATH = Path.Combine("NoxyTools", "NoxypediaEditor", "Config", nameof(CraftRecipeEditor));
